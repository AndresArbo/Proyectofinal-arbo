...
namespace View
{
    class View
    {
        ...
        {
            Console.WriteLine("Bienvenido a la maquina dispensadora de arbo");

            ConsumableController controller = new ConsumableController(new Consumable[2] { new Consumable(1, 1500, 3, "Galletas oreo"), new Consumable(2, 800, 5, "papas margarita") });
